...
<Callout title="Routines and permissions">
  Nobody is there to answer a permission card during a run. A routine can only take plugin actions that [Auto-review](/docs/auto-review) or one of your rules allows; anything that would ask is refused.
</Callout>
