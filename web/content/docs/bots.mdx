---
title: Bots
description: A bot is a persistent, named teammate with its own instructions, memory, model, and a computer it runs on.
icon: Bot
---

A bot is a teammate with one job. It has a name, instructions, a model, its own [memory](/docs/memory), and a **Runner**: the computer it works on. Every bot has one direct chat with you, and can join [group chats](/docs/group-chats).
...
| **Label** | Its role in a word or two, such as Research, Ops, or Writing. |
| **Description** | A sentence or two about what it does. Other bots read this to decide who gets a piece of work. |
| **Instructions** | How it should work: its job, its standards, what to avoid. |
| **Runner** | The computer it runs on. Any paired Mac, Linux, or Windows device. |
...
Bots can edit each other too. "Chef, make Scout's replies shorter" changes Scout's instructions.
