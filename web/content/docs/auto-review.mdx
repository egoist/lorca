...
- **Always allow** runs it and adds a narrow rule. Plugin rules name the exact tool; local rules are bound to that Runner, working directory, and exact action. Settings shows the complete reviewed command with its Runner and working directory.
