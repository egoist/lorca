...
Every command a bot runs shows in the chat as one card, from start to finish: while Auto-review checks it, while it asks for your permission (**Allow once**, **Always allow**, or **Deny**), while it runs, with its latest output, and once it ends, as one line that says how. Click or tap the command to see all of it.
...
- **Stop** from the card, or with **Stop** in the chat.
