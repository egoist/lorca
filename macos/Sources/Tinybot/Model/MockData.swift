...
enum MockData {
    ...
    private static func patchThread() -> [Message] {
        [
            Message(
                author: .you,
                body: .text("Why is `tinybot serve` binding to 4862 and not something memorable?"),
    ...
    static func pairingString() -> String {
        "tinybot://pair?relay=https%3A%2F%2Ftinybot.dev&id=idk_9f2c41ab&ek=ek_57ca0d3b&n=482913"
    }
}
