...
enum MainMenu {
    static func build() -> NSMenu {
        let main = NSMenu()
        main.addItem(submenu(appMenu(), title: "Tinybot"))
    ...
    private static func appMenu() -> NSMenu {
        let menu = NSMenu()
        add(menu, "About Tinybot", #selector(NSApplication.orderFrontStandardAboutPanel(_:)))
        ...
        menu.addItem(.separator())
        add(menu, "Hide Tinybot", #selector(NSApplication.hide(_:)), "h")
        add(
        ...
        menu.addItem(.separator())
        add(menu, "Quit Tinybot", #selector(NSApplication.terminate(_:)), "q")
        return menu
    }
    ...
    private static func helpMenu() -> NSMenu {
        let menu = NSMenu()
        add(menu, "Tinybot Help", #selector(AppDelegate.showHelp(_:)), "?")
