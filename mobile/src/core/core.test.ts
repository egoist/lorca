...
describe("format", () => {
  const bots = new Map<string, Bot>([
    ["b1", { id: "b1", name: "Chef", tagline: "", symbol_name: "sparkles", accent: "indigo", runner_id: "r", provider: "deepseek", instructions: "", created_at: 0 }],
    ["b2", { id: "b2", name: "Scout", tagline: "", symbol_name: "magnifyingglass", accent: "teal", runner_id: "r", provider: "deepseek", instructions: "", created_at: 0 }],
  ]);
